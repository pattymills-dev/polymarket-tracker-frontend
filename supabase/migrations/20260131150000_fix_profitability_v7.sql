-- ============================================
-- FIXED v7: Better ranking algorithm
-- Returns ALL traders without arbitrary sorting/limit
-- Let the frontend decide how to sort and filter
-- ============================================
...
BEGIN
  ...
  -- No ORDER BY or LIMIT - let the frontend handle sorting/filtering
END;
$$ LANGUAGE plpgsql;
